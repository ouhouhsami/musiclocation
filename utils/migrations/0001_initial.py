...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('utils_itemlocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item_type', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ...
        db.send_create_signal('utils', ['ItemLocation'])


    def backwards(self, orm):
        # Deleting model 'ItemLocation'
        db.delete_table('utils_itemlocation')
    ...
    models = {
        ...
        'utils.itemlocation': {
            ...
            'item_type': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
